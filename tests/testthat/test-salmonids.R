...
test_that("salmonids columns have correct data types", {
  ...
  expect_type(salmonids$PROJ_NAME, "character")
  expect_type(salmonids$SPECIES_CODE, "integer")
  expect_type(salmonids$SPECIES_NAME, "character")
  expect_type(salmonids$RUN_CODE, "integer")
  expect_type(salmonids$RUN_NAME, "character")
  expect_type(salmonids$BROOD_YEAR, "integer")
  ...
  expect_type(salmonids$TAG_USE_INDEX, "integer")
  expect_type(salmonids$MRP_TAGCODE, "character")
  expect_type(salmonids$RELEASE_YEAR, "integer")
  expect_type(salmonids$START_DATE, "double")
  expect_type(salmonids$END_DATE, "double")
  ...
  expect_type(salmonids$TotTagged, "integer")
  expect_type(salmonids$TotRelease, "integer")
  expect_type(salmonids$Age, "integer")
  expect_type(salmonids$RLDT_ID, "double")
  expect_type(salmonids$RecovYear, "integer")
